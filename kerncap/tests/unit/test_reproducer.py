...
class TestTritonReproducer:
    ...
    def test_autotune_config_synthesized_from_args(self, tmp_path):
        ...
        meta = {
            ...
            "block": {"x": 64, "y": 1, "z": 1},
            "args": [
                {"index": 0, "name": "Q", "is_pointer": True, "is_const": True,
                 "is_autotune_config": False, "file": "arg_0.bin",
                 "buffer_size": 256, "shape": [64], "torch_dtype": "torch.float16"},
                {"index": 1, "name": "K", "is_pointer": True, "is_const": True,
                 "is_autotune_config": False, "file": "arg_1.bin",
                 "buffer_size": 256, "shape": [64], "torch_dtype": "torch.float16"},
                {"index": 2, "name": "Out", "is_pointer": True, "is_const": False,
                 "is_autotune_config": False, "file": "arg_2.bin",
                 "buffer_size": 256, "shape": [64], "torch_dtype": "torch.float16"},
                {"index": 3, "name": "N", "type": "int", "value": 64,
                 "is_pointer": False, "is_autotune_config": False},
                {"index": 4, "name": "BLOCK_M", "type": "int", "value": 64,
                 "is_pointer": False, "is_autotune_config": True},
            ],
        }
        (cap_dir / "metadata.json").write_text(json.dumps(meta))
        ...
        meta = {
            ...
            "args": [
                {"index": 0, "name": "Q", "is_pointer": True, "is_const": True,
                 "is_autotune_config": False, "file": "arg_0.bin",
                 "buffer_size": 256, "shape": [64], "torch_dtype": "torch.float16"},
                {"index": 1, "name": "Out", "is_pointer": True, "is_const": False,
                 "is_autotune_config": False, "file": "arg_1.bin",
                 "buffer_size": 256, "shape": [64], "torch_dtype": "torch.float16"},
                {"index": 2, "name": "N", "type": "int", "value": 64,
                 "is_pointer": False, "is_autotune_config": False},
                {"index": 3, "name": "BLOCK_M", "type": "int", "value": 64,
                 "is_pointer": False, "is_autotune_config": True},
            ],
        }
        (cap_dir / "metadata.json").write_text(json.dumps(meta))
        ...
        meta = {
            ...
            "args": [
                {"index": 0, "name": "Q", "is_pointer": True, "is_const": True,
                 "is_autotune_config": False, "file": "arg_0.bin",
                 "buffer_size": 256, "shape": [64], "torch_dtype": "torch.float16"},
                {"index": 1, "name": "BLOCK_M", "type": "int", "value": 64,
                 "is_pointer": False, "is_autotune_config": True},
            ],
        }
        (cap_dir / "metadata.json").write_text(json.dumps(meta))
