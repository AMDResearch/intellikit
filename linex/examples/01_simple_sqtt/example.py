...
"""
    ...
    print(f"{'':40} {'':35} {'(cycles)':>10} {'(cycles)':>10} {'(cycles)':>10} {'(count)':>8} {'':>10}")
    print("-"*130)
    ...
    for line in our_lines[:5]:
        ...
        if first_inst:
            ...
            print(f"{source_text:<40} {isa_text:<35} {first_inst.latency_cycles:>10,} {first_inst.stall_cycles:>10,} {first_inst.idle_cycles:>10,} {first_inst.execution_count:>8,} 0x{first_inst.instruction_address:08x}")
        ...
        for inst in line.instructions[1:]:
            ...
            print(f"{'':40} {isa_text:<35} {inst.latency_cycles:>10,} {inst.stall_cycles:>10,} {inst.idle_cycles:>10,} {inst.execution_count:>8,} 0x{inst.instruction_address:08x}")
