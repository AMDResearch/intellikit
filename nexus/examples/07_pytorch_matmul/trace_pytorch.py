...
"""
Nexus driver for Example 07: trace ``tensor_matmul.py`` and print kernels + assembly sample.
"""
...
def main() -> int:
    ...
    print("=" * 60)
    print("Nexus example: PyTorch matrix multiply")
    print("=" * 60)
