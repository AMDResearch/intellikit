...
Same workload narrative as other IntelliKit packages. Accordo validation in this
folder uses the HIP pair in ``validate.py``; this script is optional cross-tool parity.
"""
