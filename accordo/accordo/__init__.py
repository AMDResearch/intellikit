...
Quick Example:
    ...
    >>> result = validator.compare_snapshots(ref, opt, tolerance=1e-6, rtol=1e-5, equal_nan=False)
...
Efficient Example (multiple comparisons):
    ...
    ...     result = validator.compare_snapshots(ref, opt, tolerance=1e-6, rtol=1e-5)
